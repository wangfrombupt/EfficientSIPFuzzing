...
/**
 *  \file modules/acc_rf/Makefile 
 * SER module Makefile
 * \author joao-f-placido -at- ptinovacao dot pt
 */

 
/** 
 * \page ACC_RF The Rf Module (acc_rf)
 *  \b Module \b Documentation
 *
 * [\subpage acc_rf_overview]
 * [\subpage acc_rf_code]
 * [\subpage acc_rf_config]
 * [\subpage acc_rf_example]  
 *
 * \section acc_rf_overview Overview
 * 
 * This module is supposed to provide the functionality required for a CSCF Charging Trigger Function.
 * 
 * To use it you need the \ref CDP loaded. This is because this module communicates using
 * Diameter with the Charging Data Function over the #IMS_Rf inteface.
 * 
 * 
 * \section acc_rf_code Code Structure
 * 
 * \section acc_rf_config Configuration and usage
 * 
 * For exported functions look at #acc_rf_cmds.\n
 * For configuration parameters look at #acc_rf_params.\n 
 * 
 *  
 * \section acc_rf_example Example
 * And here is a real usage example:
 * - Serving-CSCF configuration file \include scscf.rf.cfg
 * 
 ...
 * \file
 * 
 * Rf interface - SER module interface
 * 
 * 
 *  \author Joao Filipe Placido joao-f-placido -at- ptinovacao dot pt
 * 
